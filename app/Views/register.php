            ...
            <div class="w3-white w3-round w3-margin-bottom w3-border" style="">
              <div class="w3-padding-large">
                ...
                <div class="w3-margin-bottom">
                  <input type="text" class="w3-input w3-round w3-border" placeholder="Enter Your Username">
                </div>
                <div class="w3-margin-bottom">
                  <input type="text" class="w3-input w3-round w3-border" placeholder="Enter Your Email">
                </div>
                <div class="w3-margin-bottom">
                  <input type="password" class="w3-input w3-round w3-border" placeholder="Choose Password">
                </div>
                ...
                <button type="button" class="w3-button w3-round w3-margin-bottom w3-primary w3-block">Sign Up</button>
